...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("ninjaMuffin", "PietMondrian", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "PietMondrian";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "PietMondrian", null, { width: 640, height: 480 });
