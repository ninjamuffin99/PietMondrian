...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__assets_data_nexa_bold_otf);
		Font.registerFont (__ASSET__assets_data_nexa_light_otf);
...
@:keep class __ASSET__assets_data_nexa_bold_otf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/data/NEXA BOLD.OTF"; fontName = "Nexa Bold"; }}
@:keep class __ASSET__assets_data_nexa_light_otf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/data/Nexa Light.otf"; fontName = "Nexa Light"; }}


#else


class __ASSET__assets_data_nexa_bold_otf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/data/NEXA BOLD.OTF"; fontName = "Nexa Bold";  }}
class __ASSET__assets_data_nexa_light_otf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/data/Nexa Light.otf"; fontName = "Nexa Light";  }}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/music/A2-01.mp3", AssetType.MUSIC);
		...
		id = "assets/images/compBRBYG.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/CompWithRBY.ase";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/images/CompWithRBY.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
...
@:keep #if display private #end class __ASSET__assets_data_nexa_bold_otf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/data/NEXA BOLD.OTF"; name = "Nexa Bold"; super (); }}
@:keep #if display private #end class __ASSET__assets_data_nexa_light_otf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/data/Nexa Light.otf"; name = "Nexa Light"; super (); }}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_data_nexa_bold_otf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/data/NEXA BOLD.OTF"; name = "Nexa Bold"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__assets_data_nexa_light_otf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/data/Nexa Light.otf"; name = "Nexa Light"; super (); }}
